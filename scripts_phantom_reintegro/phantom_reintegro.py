...
async def main():
    ...
    discord.send_ingreso("Phantom Reintegro")
    ...
    if sesion_actual:
        ...
        discord.send_webhook(sesion_actual, len(sesion_actual), "Phantom Reintegro", is_reintegro=True)
    else:
...
if __name__ == "__main__":
    ...
    try:
        ...
        discord.send_webhook(sesion_actual, len(sesion_actual), "Phantom Reintegro", is_interrupted=True, is_reintegro=True)
        sys.exit(0)
    except Exception as e:
        print(f"\n\n🚨 ERROR CRÍTICO: {e}")
        discord.send_error("Phantom Reintegro", str(e))
...
def main():
    ...
    discord.send_ingreso("Switch PoE 2.5Gb Masivo")
    
    backup = MacBackup(BASE_DIR, "POE_2_5GB_MASIVO")
    ...
    try:
        ...
        discord.send_webhook([], 0, "Switch PoE 2.5Gb Masivo", is_interrupted=True)
        return
    except: return
    ...
    discord.send_webhook(exitos, target, "Switch PoE 2.5Gb Masivo")
...
if __name__ == "__main__":
    try:
        ...
        try:
            d = DiscordNotifier()
            d.send_webhook([], 0, "Switch PoE 2.5Gb Masivo", is_interrupted=True)
        except: pass
    except Exception as e:
        print(f"\n\n🚨 ERROR CRÍTICO: {e}")
        try:
            d = DiscordNotifier()
            d.send_error("Switch PoE 2.5Gb Masivo", str(e))
        except: pass

...
# =====================================================================
# CONFIGURACIÓN DEL SISTEMA (V33 STABLE + MAC LOG)
# =====================================================================
...
MAX_WORKERS = 10  # Volvemos a 10 para maxima estabilidad
...
def main():
    ...
    print(f"{Colors.CYAN}==========================================================")
    print(f"   HELLOTEK - V33 STABLE (REGRESO A ESTABILIDAD)         ")
    print(f"=========================================================={Colors.END}")
    ...
    while len(discovered) < target:
        ...
        if auth:
            ...
            if mac and not any(d['mac'] == mac for d in discovered):
                ...
                if esperar_equipo_original(temp_ip, 15):

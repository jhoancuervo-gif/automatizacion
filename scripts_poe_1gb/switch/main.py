...
async def main():
    ...
    for i in range(op):
        ...
        # Esperar que el switch reinicie después del firmware
        ...
        print("\n===== ETAPA 2: CONFIG =====")
        await config()
        print("Esperando reinicio único final...")
        # Único reinicio para aplicar configuración
        if not esperar_reinicio_switch(IP, timeout_maximo=180):
            print("Switch no volvió tras el proceso")
            continue
